...
#include<stdio.h>                       //(input/output programs)
#include<conio.h>               
#include <stdlib.h>     
...
void gotoxy (int x, int y)      //goto function used to jump the program from one to another.
{
...
struct books                   //(structure function used)
{
int id;                   //declaration of function 
char stname[20];
char name[20];
char Author[20];
int quantity;
...
switch(getch())                      //selection statements
{                                       
case '1':
addbooks();
break;
...
gotoxy(16,4);
printf("\t                   AeU University "                );
gotoxy(16,5);
printf("\t                  VIRINCHI COLLEGE                ");
gotoxy(16,7);
printf("\t                  Kumaripati, Lalitpur            ");
gotoxy(16,8);
printf("\t                  Contact: +97701-5553396");
gotoxy(16,10);
...
if(getch())                                   //decision making statements
mainmenu();
}
...
char ch,pass[20],password[20]="123";
int i=0,j;
