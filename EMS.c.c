...
void requestLeave() {
    ...
    scanf("%d", &employeeID);
    FILE *f = fopen("leaveData.txt", "a");

    if(f == NULL) {
        printf("You cannot take leave right now");
        return;
    }
    while(fscanf(fp, "%s %d %d %d", e.name, &e.age, &e.salary, &e.id) != EOF) {
        if(e.id == employeeID) {
    ...
    printf("Sorry there is no employee with this ID");
    fclose(f);
...
void employeeStatus() {
    system("cls");
    FILE *fp = fopen("leaveData.txt", "r");
    if(fp == NULL) {
        printf("Sorry there is no leave data with us");
        return;
    }
    
    printf("leave taken by:\n");
    printf("==========================="
           "==========================="
           "=============\n");
    while(fscanf(fp, "%s %d", e.name, &e.id) != EOF) {
            printf("%s\t%d\n", e.name, e.id);
    }
    fclose(fp);
}
...
int main()
{
   ...
   printf("\n\t\t\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\n");
	printf("\t\t\xdb                                               \xdb\n");
	printf("\t\t\xdb          =============================        \xdb\n");
	printf("\t\t\xdb            Employee management                \xdb\n");
	...
	printf("\t\t\xdb                                               \xdb\n");
	printf("\t\t\xdb                                               \xdb\n");
	printf("\t\t\xdb         CONTACT US:9888888888,038520450       \xdb\n");
